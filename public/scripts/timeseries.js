...
//
//
// d3.csv("Firearms_Discharge_Report2.csv", function(error, data) {
//   if (error) throw error;
//
//   data.forEach(function(d) {
//     dataSeries = {};
//     dataSeries.year = parseDate(d.Year);
//     dataSeries.adversarialConflict = (parseInt(d.AdversarialConflict));
//   })
//   console.log(adversarialConflict);
//   debugger;
